...
def start_pannel():
    buttons = [
        ...
        [
            InlineKeyboardButton("📚 ᴄᴏᴍᴍᴀɴᴅ​ 📚", url="https://geekmusic.mhpay.repl.co/wsbmusik/docs.html"),
        ],
        [
            InlineKeyboardButton("🌐 sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ 🌐", url="https://github.com/GeekMusik/WsbMusik"),
...
💬 [{BOT_NAME}](tg://user?id=1884318838) memungkinkan anda untuk memutar musik pada grup melalui obrolan suara yang baru di Telegram!
